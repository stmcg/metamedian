#' Example data set: Comparing the age between COVID-19 survivors and nonsurvivors
#'
...
#' Example data set: Comparing aspartate transaminase levels between COVID-19 survivors and nonsurvivors
#'
